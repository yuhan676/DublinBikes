    ...
    try {
        ...
        google.charts.setOnLoadCallback(function() {
            ...
            var hourlyBikeData = google.visualization.arrayToDataTable([
                ...
                [hour + ':00', stationData.total_bikes[0], 'color: #76A7FA'],
                [(hour + 1)+ ':00', stationData.total_bikes[1], 'color: #76A7FA'],
                [(hour + 2)+ ':00', stationData.total_bikes[2], 'color: #76A7FA'],
                [(hour + 3)+ ':00', stationData.total_bikes[3], 'color: #76A7FA'],
                [(hour + 4)+ ':00', stationData.total_bikes[4], 'color: #76A7FA'],
                [(hour + 5)+ ':00', stationData.total_bikes[5], 'color: #76A7FA'],
                [(hour + 6)+ ':00', stationData.total_bikes[6], 'color: #76A7FA'],
                [(hour + 7)+ ':00', stationData.total_bikes[7], 'color: #76A7FA'],
                [(hour + 8)+ ':00', stationData.total_bikes[8], 'color: #76A7FA'],
                [(hour + 9)+ ':00', stationData.total_bikes[9], 'color: #76A7FA'],
                [(hour + 10)+ ':00', stationData.total_bikes[10], 'color: #76A7FA'],
                [(hour + 11)+ ':00', stationData.total_bikes[11], 'color: #76A7FA'],
                [(hour + 12)+ ':00', stationData.total_bikes[12], 'color: #76A7FA'],
                [(hour + 13)+ ':00', stationData.total_bikes[13], 'color: #76A7FA'],
                [(hour + 14)+ ':00', stationData.total_bikes[14], 'color: #76A7FA'],
                [(hour + 15)+ ':00', stationData.total_bikes[15], 'color: #76A7FA'],
                [(hour + 16)+ ':00', stationData.total_bikes[16], 'color: #76A7FA'],
                [(hour + 17)+ ':00', stationData.total_bikes[17], 'color: #76A7FA'],
                [(hour + 18)+ ':00', stationData.total_bikes[18], 'color: #76A7FA'],
                [(hour + 19)+ ':00', stationData.total_bikes[19], 'color: #76A7FA'],
                [(hour + 20)+ ':00', stationData.total_bikes[20], 'color: #76A7FA'],
                [(hour + 21)+ ':00', stationData.total_bikes[21], 'color: #76A7FA'],
                [(hour + 22)+ ':00', stationData.total_bikes[22], 'color: #76A7FA'],
                [(hour + 23)+ ':00', stationData.total_bikes[23], 'color: #76A7FA']
            ]);
            ...
            var hourlyParkingData = google.visualization.arrayToDataTable([
                ...
                [hour + ':00', stationData.empty_stands_number[0],'color: #b87333'],
                [(hour + 1) + ':00', stationData.empty_stands_number[1], 'color: #b87333'],
                [(hour + 2) + ':00', stationData.empty_stands_number[2], 'color: #b87333'],
                [(hour + 3)+ ':00', stationData.empty_stands_number[3], 'color: #b87333'],
                [(hour + 4)+ ':00', stationData.empty_stands_number[4], 'color: #b87333'],
                [(hour + 5)+ ':00', stationData.empty_stands_number[5], 'color: #b87333'],
                [(hour + 6)+ ':00', stationData.empty_stands_number[6], 'color: #b87333'],
                [(hour + 7)+ ':00', stationData.empty_stands_number[7], 'color: #b87333'],
                [(hour + 8)+ ':00', stationData.empty_stands_number[8], 'color: #b87333'],
                [(hour + 9)+ ':00', stationData.empty_stands_number[9], 'color: #b87333'],
                [(hour + 10)+ ':00', stationData.empty_stands_number[10], 'color: #b87333'],
                [(hour + 11)+ ':00', stationData.empty_stands_number[11], 'color: #b87333'],
                [(hour + 12)+ ':00', stationData.empty_stands_number[12], 'color: #b87333'],
                [(hour + 13)+ ':00', stationData.empty_stands_number[13], 'color: #b87333'],
                [(hour + 14)+ ':00', stationData.empty_stands_number[14], 'color: #b87333'],
                [(hour + 15)+ ':00', stationData.empty_stands_number[15], 'color: #b87333'],
                [(hour + 16)+ ':00', stationData.empty_stands_number[16], 'color: #b87333'],
                [(hour + 17)+ ':00', stationData.empty_stands_number[17], 'color: #b87333'],
                [(hour + 18)+ ':00', stationData.empty_stands_number[18], 'color: #b87333'],
                [(hour + 19)+ ':00', stationData.empty_stands_number[19], 'color: #b87333'],
                [(hour + 20)+ ':00', stationData.empty_stands_number[20], 'color: #b87333'],
                [(hour + 21)+ ':00', stationData.empty_stands_number[21], 'color: #b87333'],
                [(hour + 22)+ ':00', stationData.empty_stands_number[22], 'color: #b87333'],
                [(hour + 23)+ ':00', stationData.empty_stands_number[23], 'color: #b87333']
            ]);
